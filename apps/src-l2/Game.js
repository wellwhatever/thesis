...
Candy.Game.prototype = {
	create: function(){
		...
		// set font style
		this._fontStyle = { font: "40px Arial", fill: "#ec008c", stroke: "#eee", strokeThickness: 5, align: "center" };
	...
	managePause: function(){
		...
		var pausedText = this.add.sprite(0,0, 'pause-screen');
		var continueGame = this.add.sprite((Candy.GAME_WIDTH-385)/2, (Candy.GAME_HEIGHT-250)/2, 'button-continue');
	...
	update: function(){
		...
		if(!Candy._health) {
			...
			this.add.button((Candy.GAME_WIDTH-385)/2, (Candy.GAME_HEIGHT-200)/2, 'button-survey',this.survey,this);
			// pause the game
			this.game.paused = true;

			this.input.onDown.add(function(){
				var win = window.open(' https://docs.google.com/forms/d/1AOTSOWLwOHchw7buMrqqNUn3VEQR9yEy35v6R6zZfLg/','Form survey L2');
			}, this);
		}
	}
	// survey: function(){
